...
import { ActivityMeetingsTable } from "./activity-meetings-table";
...
export default function ActivityMeetingsPage() {
  ...
  const { data, isLoading, isRefetching } = useActivityMeetings(
    orgId,
    {
      page,
      pageSize,
  ...
  return (
    <div className="container mx-auto max-w-6xl p-4">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-md font-semibold">Activity Meetings</h1>
          <p className="text-muted-foreground text-xs">
            Meetings linked to leads and deals.
          </p>
        </div>
