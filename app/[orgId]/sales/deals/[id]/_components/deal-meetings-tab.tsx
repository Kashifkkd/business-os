...
type DealMeetingsTabProps = {
  orgId: string;
  dealId: string;
};

export function DealMeetingsTab({ orgId, dealId }: DealMeetingsTabProps) {
  const { data, isLoading } = useActivityMeetings(
    orgId,
    { page: 1, pageSize: 50, dealId },
      ...
      <div className="flex h-full flex-col p-4">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Button asChild size="sm">
            <Link href={`/${orgId}/activities/meetings/new?dealId=${dealId}`}>
